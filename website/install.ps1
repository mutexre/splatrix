...
Write-Host "To uninstall: Remove-Item -Recurse -Force ~\.splatrix; Remove-Item -Force ~\Desktop\Splatrix.lnk,'$env:APPDATA\Microsoft\Windows\Start Menu\Programs\Splatrix.lnk' -ErrorAction SilentlyContinue"
Write-Host ""
